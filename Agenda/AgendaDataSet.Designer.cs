...
namespace Agenda {
    ...
    public partial class AgendaDataSet : global::System.Data.DataSet {
        ...
        public partial class AlumnosDataTable : global::System.Data.TypedTableBase<AlumnosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public AlumnosRow AddAlumnosRow(string Nombre, int Edad, string Telefono, string Correo) {
...
namespace Agenda.AgendaDataSetTableAdapters {
    ...
    public partial class AlumnosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Alumnos` WHERE ((`Matricula` = ?) AND ((? = 1 AND `Nombre` IS NULL) OR (`Nombre` = ?)) AND ((? = 1 AND `Edad` IS NULL) OR (`Edad` = ?)) AND ((? = 1 AND `Telefono` IS NULL) OR (`Telefono` = ?)) AND ((? = 1 AND `Correo` IS NULL) OR (`Correo` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Alumnos` (`Nombre`, `Edad`, `Telefono`, `Correo`) VALUES (?, ?, ?, ?" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Alumnos` SET `Nombre` = ?, `Edad` = ?, `Telefono` = ?, `Correo` = ? WHERE ((`Matricula` = ?) AND ((? = 1 AND `Nombre` IS NULL) OR (`Nombre` = ?)) AND ((? = 1 AND `Edad` IS NULL) OR (`Edad` = ?)) AND ((? = 1 AND `Telefono` IS NULL) OR (`Telefono` = ?)) AND ((? = 1 AND `Correo` IS NULL) OR (`Correo` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Matricula, Nombre, Edad, Telefono, Correo FROM Alumnos";
        ...
        public virtual int Fill(AgendaDataSet.AlumnosDataTable dataTable) {
        ...
        public virtual AgendaDataSet.AlumnosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AgendaDataSet.AlumnosDataTable dataTable = new AgendaDataSet.AlumnosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AgendaDataSet.AlumnosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Matricula, string Original_Nombre, global::System.Nullable<int> Original_Edad, string Original_Telefono, string Original_Correo) {
        ...
        public virtual int Insert(string Nombre, global::System.Nullable<int> Edad, string Telefono, string Correo) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, global::System.Nullable<int> Edad, string Telefono, string Correo, int Original_Matricula, string Original_Nombre, global::System.Nullable<int> Original_Edad, string Original_Telefono, string Original_Correo) {
            if ((Nombre == null)) {
